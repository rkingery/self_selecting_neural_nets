...
def add_del_neurons(parameters, print_add_del, del_threshold=0.05, prob_del=0.05, 
                    prob_add=0.01, max_hidden_size=300, num_below_margin=1):
    """
...
def MLP(X, y, layers_dims, lr=0.01, num_iters=1000, print_loss=False, print_add_del=False):
    """
...
if __name__ == '__main__':
    ...
    print 'R^2 = ',score(X,y,parameters)
